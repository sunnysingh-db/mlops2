...
# ``sunny_mlops/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "model_name", "dev.sunny_mlops.sunny_mlops-model", label="Full (Three-Level) Model Name"
)
...
dbutils.widgets.text(
    ...
    "dev.sunny_mlops.trip_dropoff_features",
