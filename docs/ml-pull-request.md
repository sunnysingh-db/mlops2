...
Opening a pull request will trigger a[workflow](../.github/workflows/sunny_mlops-run-tests.yml) 
...
Links:
* [Staging model in UC](https://adb-984752964297111.11.azuredatabricks.net/explore/data/models/staging/sunny_mlops/sunny_mlops-model)
* [Prod model in UC](https://adb-984752964297111.11.azuredatabricks.net/explore/data/models/prod/sunny_mlops/sunny_mlops-model)
. 
