...
git add README.md docs .gitignore sunny_mlops/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. 
  ...
  [prod workspace admin console](https://adb-984752964297111.11.azuredatabricks.net#setting/accounts). 
...
If you want to use different catalog names, please update the target names declared in the[sunny_mlops/databricks.yml](../sunny_mlops/databricks.yml) file.
...
Follow the instructions in [sunny_mlops/resources/README.md](../sunny_mlops/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../sunny_mlops/resources/README.md)  to propose, test, and deploy
